...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerServiceImpl(
            ...
            RoleConverter roleConverter, AddressConverter addressConverter, AddressService addressService) {
    ...
    public CustomerDto register(CreateCustomerRequest createCustomerRequest) {
        Role role =
               roleConverter.convertToEntity(roleService.getRoleById(createCustomerRequest.getRoleId()));

        Address address =
                addressConverter.convertToEntity(add)
                ;
        Customer customer =
                new Customer(
